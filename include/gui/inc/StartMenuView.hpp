...
class StartMenuView : public StartMenuIf, public MainEngineIf, public DrawableManagerIf, public EventHandlerIf
{
public:
  StartMenuView(std::shared_ptr<AssetsMenagerIf> spAssetsMenager, std::shared_ptr<SettingsAdvance> settingsAdvance, std::shared_ptr<StateManagerIf> stateManager);
  //~StartMenuView();
  ~StartMenuView() = default;
...
private:
  ...
  std::shared_ptr<StartMenuKoper> m_upStartMenu;
